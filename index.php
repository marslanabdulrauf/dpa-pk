	...
	<head>
		...
		<!-- Meta Description -->
		<meta name="description" content="Dental Prosthetist">
		<!-- Meta Keyword -->
		<meta name="keywords" content="">
		<!-- meta character set -->
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Dental Prosthetist Association</title>
		<!--
		CSS
		============================================= -->
		<?php
			...
			<div class="container">
				<div class="row fullscreen d-flex justify-content-center align-items-center">
					<div class="banner-content col-lg-9 col-md-12 justify-content-center">
						<h6 class="text-uppercase">One and ONLY Association in Pakistan</h6>
						<h1>
